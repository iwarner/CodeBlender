 ...
 * Helper
 *
 * // Facebook Regestration
 * echo $this->facebook_Registration();
 *
 * @category   CodeBlender
 * @package    Helper
 * @copyright  Copyright (c) 2011 Triangle Solutions Ltd. (http://www.triangle-solutions.com/)
 ...
 */
class CodeBlender_View_Helper_Facebook_Registration extends Zend_View_Helper_Abstract
{
     ...
     * @return string
     */
    public function facebook_Registration($params = array())
    {
