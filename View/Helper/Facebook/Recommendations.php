 ...
 * echo $this->facebook_Recommendations();
 * </code>
 *
 * @category   CodeBlender
 * @package    Helper
 ...
 */
class CodeBlender_View_Helper_Facebook_Recommendations extends Zend_View_Helper_Abstract
{
...
//max_age - the maximum age of a URL to show in the plugin. The default is 0 (we don’t take age into account). Otherwise the valid values are 1-180, which specifies the number of days. For example, if you specify '7' the plugin will only show URLs which were created in the past week.
     ...
     * Facebook Comments
     */
    public function facebook_Recommendations($params = array())
    {
...
HTML;
            ...
            $string = <<<HTML
                <iframe src="//www.facebook.com/plugins/recommendations.php?site&amp;width=300&amp;height=300&amp;header=true&amp;colorscheme=light&amp;linktarget=_blank&amp;border_color&amp;font&amp;appId=259413234111137" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:300px; height:300px;" allowTransparency="true"></iframe>
HTML;
        }
