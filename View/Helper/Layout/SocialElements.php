 ...
 * @license    http://codeblender.net/license
 */
class CodeBlender_View_Helper_Layout_SocialElements extends Zend_View_Helper_Abstract
{

    /**
     * Social Elements
     */
    public function layout_SocialElements()
    {
        $string = <<<HTML
            <div class="socialElements">

                <div class="facebookLike">
                    {$this->view->facebook_Like(array('layout' => 'button_count'))}
                </div>
