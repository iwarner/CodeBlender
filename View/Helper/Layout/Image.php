 ...
 *
 * @todo Sort out the Properties into proper class properties
 */

/**
 * Helper class to display an image
 *
 * // For Displaying an Image based on the Config assetPath
 * echo $this->layout_Image(array(
 ...
 * @license    http://codeblender.net/license
 */
class CodeBlender_View_Helper_Layout_Image extends Zend_View_Helper_Abstract
{
     ...
     * @return string         HTML
     */
    public function layout_Image($params = array())
    {
