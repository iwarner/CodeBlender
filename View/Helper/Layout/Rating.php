...
/**
 * Helper class to produce an AJAX Rating System.
 *
 ...
 */
class CodeBlender_View_Helper_Layout_Rating extends Zend_View_Helper_Abstract
{
    /**
     ...
     * @return string
     */
    public function layout_Rating($params = array())
    {
