...
class CodeBlender_Controller_Plugin_Debug_Plugin_Time extends Zend_Controller_Plugin_Abstract implements CodeBlender_Controller_Plugin_Debug_Plugin_Interface
{
    ...
    public function getPanel()
    {
        ...
        $html .= 'Dispatch: ' . round(($this->_timer['dispatchLoopShutdown'] - $this->_timer['dispatchLoopStartup']), 2) . ' ms<br />';
        ...
        $html .= '<br />Reset timers by sending CBDRESET as a GET/POST parameter';
    ...
    {
        $reset = Zend_Controller_Front::getInstance()->getRequest()->getParam('CBDRESET');
