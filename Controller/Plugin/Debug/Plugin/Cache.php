 ...
 * @license    http://www.codeblender.net/license
 */
class CodeBlender_Controller_Plugin_Debug_Plugin_Cache implements CodeBlender_Controller_Plugin_Debug_Plugin_Interface
{
    /**
    ...
    /**
     * Create CodeBlender_Controller_Plugin_Debug_Plugin_Cache
     *
     * @param  array $options
     * @return void
     */
    public function __construct(array $options = array())
    {
        if (!isset($options['backend'])) {
            throw new Zend_Exception("CodeBlender: Cache plugin needs 'backend' parameter");
        }
